 ...
 */
@Singleton
@Component(modules = ShareDeckActivityModule.class)
public interface ShareDeckActivityComponent {

    /**
     * Dagger injector.
     *
     * @param shareDeckActivity sets a type for injection
     */
    void inject(ShareDeckActivity shareDeckActivity);
}
